...
export default function RegisterCandidate() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // dynamic import for api since it's only needed here
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-black text-secondary-900 dark:text-white mb-2 tracking-tight">Create Candidate Account</h1>
        <p className="text-secondary-500 dark:text-secondary-400">Find your next great opportunity</p>
      </div>
