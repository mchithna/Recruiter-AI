  ...
  return (
    <div className="w-full max-w-lg mx-auto p-8 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-100 dark:border-slate-700">
      <div className="text-center mb-8">
        <h1 className="text-h3 font-bold text-secondary-900 dark:text-white mb-2">Create Company Account</h1>
        <p className="text-body-md text-secondary-500">Hire your next great team member</p>
      </div>
